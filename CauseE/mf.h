...
public:
    ...
    shared_ptr<ImpData> treat_data;
    shared_ptr<ImpData> test_data;
    shared_ptr<Parameter> param;
    ImpProblem(shared_ptr<ImpData> &data, shared_ptr<Parameter> &param)
        :data(data), param(param) {};
    ImpProblem(shared_ptr<ImpData> &data,  shared_ptr<ImpData> &treat_data, shared_ptr<ImpData> &test_data, shared_ptr<Parameter> &param)
        :data(data), treat_data(treat_data), test_data(test_data), param(param) {};
    ...
    vector<ImpFloat> gamma_w_treat, gamma_h_treat;
